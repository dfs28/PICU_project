### Script for hyperparameter training of depthwise dilated 1d net
...
def TPC(hp):
    ...
    for i in range(hp.Int('num_layers', 1, 3)):
        x = tf.keras.layers.SeparableConv1D(hp.Int("num_filters" + str(i), min_value=10, max_value=50, step=5, default = 50), 
                      hp.Int("kernel_size" + str(i), min_value=5, max_value=60, step=5, default = 32), activation='relu', padding = 'causal',
