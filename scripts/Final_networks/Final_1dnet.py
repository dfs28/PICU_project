...
for i in range(7):
    ax1.plot(filters[:, i, 1])
ax1.set_title('Layer 1 Filters')
ax1.set(xlabel = 'Position', ylabel = 'Value')

filters, biases = full_model.layers[2].get_weights()
for i in range(7):
    ax2.plot(filters[:, i, 1])
ax2.set_title('Layer 2 Filters')
ax2.set(xlabel = 'Position', ylabel = 'Value')
plt.tight_layout(h_pad = 0.3)
plt.savefig('/mhome/damtp/q/dfs28/Project/PICU_project/figs/PICU/filters.png')
...
a_file = open("/mhome/damtp/q/dfs28/Project/PICU_project/files/1Dnet_results2", "w")
