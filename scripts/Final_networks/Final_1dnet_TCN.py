...
tf.keras.utils.plot_model(full_model, to_file='/mhome/damtp/q/dfs28/Project/PICU_project/models/1d_CNN_TCN.png', show_shapes=True, expand_nested = True)
...
a_file = open("/mhome/damtp/q/dfs28/Project/PICU_project/files/1Dnet_TCN_results", "w")
