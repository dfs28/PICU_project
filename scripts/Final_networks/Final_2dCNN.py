...
def make_2DNET(model_type):
    ...
    death_head = layers.Dense(3, activation = 'softmax', use_bias = True, kernel_initializer = init)(dense2)
    time_head = layers.Dense(3, activation = 'softmax', use_bias = True, kernel_initializer = init)(dense2)
    PEWS_head = layers.Dense(3, activation = 'softmax', use_bias = True, kernel_initializer = init)(dense2)
...
a_file = open("/mhome/damtp/q/dfs28/Project/PICU_project/files/2DCNN_results", "w")
