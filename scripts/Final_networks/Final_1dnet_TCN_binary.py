...
conf_mat1 = confusion_matrix(np.argmax(y_pred1, axis = 1), np.argmax(binary_death_train_outcomes, axis = 1))
conf_mat2 = confusion_matrix(np.argmax(y_pred2, axis = 1), np.argmax(binary_LOS_train_outcomes, axis = 1))
conf_mat3_2 = confusion_matrix(np.argmax(y_pred3, axis = 1), np.argmax(binary_deterioration_test_outcomes, axis = 1))
