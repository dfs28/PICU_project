...
binary_deterioration_train_9h = np.array(train_outcomes[:, 12] < 9, dtype = int)
binary_deterioration_train_outcomes = np.transpose(np.array([1- binary_deterioration_train_9h, binary_deterioration_train_9h]))

binary_deterioration_test_9h = np.array(test_outcomes[:, 12] < 9, dtype = int)
binary_deterioration_test_outcomes = np.transpose(np.array([1- binary_deterioration_test_9h, binary_deterioration_test_9h]))
...
if os.path.exists('/mhome/damtp/q/dfs28/Project/PICU_project/models/XGBoost_best_9h_slope.json') == False:                         
    ...
    all_models.to_csv('/mhome/damtp/q/dfs28/Project/PICU_project/files/xgb_opt' + clf_name +"_cv_results_9h.csv")
    ...
    a_file = open("/mhome/damtp/q/dfs28/Project/PICU_project/models/XGBoost_best_9h_slope.json", "w")
    json.dump(best_hyperparameters, a_file)
    a_file.close()

else:
    f = open("/mhome/damtp/q/dfs28/Project/PICU_project/models/XGBoost_best_9h_slope.json", )
...
a_file = open("/mhome/damtp/q/dfs28/Project/PICU_project/files/XGBoost_results_slope_9h_binary", "w")
