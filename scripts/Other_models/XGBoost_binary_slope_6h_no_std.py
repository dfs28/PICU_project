...
#Set x and y
X = np.concatenate((train_array2d, train_characteristics[:, :60], train_slopes, train_R), axis=1)
...
if os.path.exists('/mhome/damtp/q/dfs28/Project/PICU_project/models/XGBoost_best_binary_slope_6h_no_std.json') == False:                         
       ...
       a_file = open("/mhome/damtp/q/dfs28/Project/PICU_project/models/XGBoost_best_binary_slope_6h_no_std.json", "w")
       json.dump(best_hyperparameters, a_file)
       a_file.close()

else:
       f = open("/mhome/damtp/q/dfs28/Project/PICU_project/models/XGBoost_best_binary_slope_6h_no_std.json", )
...
X_test = np.concatenate((test_array2d, test_characteristics[:, :60], test_slopes, test_R), axis=1)
...
a_file = open("/mhome/damtp/q/dfs28/Project/PICU_project/files/XGBoost_results_slope_binary_6h_no_std", "w")
