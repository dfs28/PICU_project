...
if os.path.exists('/mhome/damtp/q/dfs28/Project/PICU_project/models/XGBoost_best_binary.json') == False:                         
       ...
       a_file = open("/mhome/damtp/q/dfs28/Project/PICU_project/models/XGBoost_best_binary.json", "w")
       ...
       f = open("/mhome/damtp/q/dfs28/Project/PICU_project/models/XGBoost_best_binary.json", )
...
a_file = open("/mhome/damtp/q/dfs28/Project/PICU_project/files/XGBoost_results_binary", "w")
