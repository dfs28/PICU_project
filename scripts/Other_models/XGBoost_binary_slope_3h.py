...
binary_deterioration_train_3h = np.array(train_outcomes[:, 12] < 3, dtype = int)
binary_deterioration_train_outcomes = np.transpose(np.array([1- binary_deterioration_train_3h, binary_deterioration_train_3h]))

binary_deterioration_test_3h = np.array(test_outcomes[:, 12] < 3, dtype = int)
binary_deterioration_test_outcomes = np.transpose(np.array([1- binary_deterioration_test_3h, binary_deterioration_test_3h]))
...
if os.path.exists('/mhome/damtp/q/dfs28/Project/PICU_project/models/XGBoost_best_3h_slope.json') == False:                         
    ...
    a_file = open("/mhome/damtp/q/dfs28/Project/PICU_project/models/XGBoost_best_3h_slope.json", "w")
    json.dump(best_hyperparameters, a_file)
    a_file.close()

else:
    f = open("/mhome/damtp/q/dfs28/Project/PICU_project/models/XGBoost_best_3h_slope.json", )
...
a_file = open("/mhome/damtp/q/dfs28/Project/PICU_project/files/XGBoost_results_slope_3h_binary", "w")
